               ...
               <tr>
                ...
                <tr>
                    <td style="width: 100%; height: 25px;">
                        ...
                        <button id="Upl1" onclick="Upl001(1);">Загрузить фото</button>
                        ...
                        <asp:Button ID="ButEmail" runat="server" onclick="SendEmail" Text="Email" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%; height: 25px;">
                        <asp:Label ID="Lbl002" Text="2.ОБРАЗ:" runat="server" Width="7%" Font-Bold="true" Font-Size="Medium" />
                        <button id="Upl1" onclick="Upl001(2);">Загрузить фото</button>
                        ...
                        <asp:Button ID="Button1" runat="server" onclick="SendEmail" Text="Email" />
                    </td>
                </tr>
                ...
                <tr>
                    <td style="width: 100%; height: 25px;">
                        ...
                        <button id="Upl1" onclick="Upl001(3);">Загрузить фото</button>
                        ...
                        <asp:Button ID="Button2" runat="server" onclick="SendEmail" Text="Email" />
                    </td>
                </tr>
