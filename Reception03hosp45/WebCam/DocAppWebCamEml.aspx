...
<script runat="server">
    ...
    // ------------------------------------------------------------------------------заполняем второй уровень
    public void SendEmail_OLD(object sender, EventArgs e)
    {
        string EmlFrom = "dauasoft@gmail.com";
        string EmlTo = "kalitulenov@mail.ru";
            ...
            <table border="0" cellspacing="0" width="100%" cellpadding="0">
               <tr>
                    <td style="width: 100%; height: 25px;">
                        <asp:Label ID="Label1" Text="1." runat="server" Width="7%" Font-Bold="true" Font-Size="Medium" />
               ...
               <tr>
                    <td style="width: 100%; height: 25px;">
                        <asp:Label ID="Label3" Text="2." runat="server" Width="7%" Font-Bold="true" Font-Size="Medium" />
              ...
              <tr>
                    <td style="width: 100%; height: 25px;">
                       ...
                       <asp:Label ID="Label2" Text="3." runat="server" Width="7%" Font-Bold="true" Font-Size="Medium" />

                       <asp:Button ID="Eml1" runat="server" onclick="SendEmail01" Text="Отправить email" />                     
                       <asp:TextBox ID="TxtEml001" Width="40%" Height="20" runat="server" Style="position: relative; font-weight: 700; font-size: medium;" />
