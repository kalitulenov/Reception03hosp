...
<script runat="server">
    ...
    void getDocNum()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            TxtZen.Text = Convert.ToString(ds.Tables[0].Rows[0]["USLFRMZEN"]);
            ...
            //          if (parUslKey.Value.Substring(0,3) == "150")
            //              SdsPrt.SelectCommand = "SELECT SPRLABNAM AS PRTKOD,SPRLABNAM AS PRTNAM FROM SPRLAB WHERE SPRLABFRM=" + BuxFrm + " GROUP BY SPRLABNAM";
            //          else BoxPrt.Items.Clear();
        }
        else
        {
    ...
    protected void ZapButton_Click(object sender, EventArgs e)
    {
        ...
        else USLFRMZENDOM = Convert.ToInt32(TxtZenDom.Text);

        if (Convert.ToString(TxtAkz.Text) == null || Convert.ToString(TxtAkz.Text) == "") USLFRMAKZ= 0;
        else USLFRMAKZ = Convert.ToInt32(TxtAkz.Text);
        ...
        cmd.Parameters.Add("@USLFRMZENDOM", SqlDbType.Int, 4).Value = USLFRMZENDOM;
        cmd.Parameters.Add("@USLFRMAKZ", SqlDbType.Int, 4).Value = USLFRMAKZ;
    ...
    protected void SdsGrp001_SelectedIndexChanged(object sender, ComboBoxItemEventArgs e)
    {
        //    SdsGrp002.SelectParameters[0].DefaultValue = BuxFrm;
        //    SdsGrp002.SelectParameters[1].DefaultValue = e.Item.Value;
        BoxGrp002.Items.Clear();
        BoxGrp003.Items.Clear();
        SdsGrp002.SelectCommand = "SELECT SprStrUsl.StrUslKey As StrUslKey002,SprStrUsl.StrUslNam As StrUslNam002 " +
                              "FROM SprStrUslFrm INNER JOIN SprStrUsl ON SprStrUslFrm.StrUslFrmKey=SprStrUsl.StrUslKey " +
                              "WHERE SprStrUslFrm.StrUslFrmHsp=" + BuxFrm + " AND LEN(SprStrUslFrm.StrUslFrmKey)=7 AND LEFT(SprStrUslFrm.StrUslFrmKey,3)='" +e.Item.Value +
                              "' ORDER BY SprStrUsl.StrUslNam";

        SdsGrp003.SelectCommand = "";
        BoxGrp002.SelectedValue = "";
        BoxGrp003.SelectedValue = "";

        BoxPrt.Items.Clear();
        string Pol = BoxGrp001.SelectedValue.ToString();  // значение COMBOBOX
        SdsPrt.SelectCommand = "SELECT SPRMEDFRMKOD,SPRMEDFRMNAM FROM SPRMEDFRM WHERE SPRMEDFRMKEY='" + Pol + "' ORDER BY SPRMEDFRMNAM";
        BoxPrt.Items.Add(new Obout.ComboBox.ComboBoxItem("нет протокола", "0"));

    }

    protected void SdsGrp002_SelectedIndexChanged(object sender, ComboBoxItemEventArgs e)
    {
        //    SdsGrp002.SelectParameters[0].DefaultValue = BuxFrm;
        //    SdsGrp002.SelectParameters[1].DefaultValue = e.Item.Value;
        BoxGrp003.Items.Clear();
        SdsGrp003.SelectCommand = "SELECT SprStrUsl.StrUslKey As StrUslKey002,SprStrUsl.StrUslNam As StrUslNam002 " +
                              "FROM SprStrUslFrm INNER JOIN SprStrUsl ON SprStrUslFrm.StrUslFrmKey=SprStrUsl.StrUslKey " +
                              "WHERE SprStrUslFrm.StrUslFrmHsp=" + BuxFrm + " AND LEN(SprStrUslFrm.StrUslFrmKey)=11 AND LEFT(SprStrUslFrm.StrUslFrmKey,7)='" +e.Item.Value +
                              "' ORDER BY SprStrUsl.StrUslNam";
    }
    // ------------------------------------------------------------------------------заполняем второй уровень
                    ...
                    <td style="width: 100%; height: 30px;">
                        ...
                        <obout:ComboBox runat="server"
                            ...
                            DataSourceID="SdsGrp001"
                             OnSelectedIndexChanged="SdsGrp001_SelectedIndexChanged"
               ...
               <tr>
                ...
                <tr>
                    <td style="width: 100%; height: 30px;">
                        ...
                        <asp:TextBox ID="TxtTrf" Width="75%" Height="20" runat="server"
                ...
                <tr>
                    <td width="100%" style="vertical-align: top;">
                        ...
                        <asp:TextBox ID="TxtNam" Width="75%" Height="40" TextMode="MultiLine" runat="server" Style="position: relative; font-weight: 700; font-size: medium;" />
                    </td>
                </tr>
                ...
                <tr>
                    <td style="width: 100%; height: 30px;"">
                        ...
                        <span  style="width:75%">
                            <asp:TextBox ID="TxtEdn" Width="15%" Height="20" runat="server" Style="position: relative; font-weight: 700; font-size: medium;" />
                            
                            <asp:Label ID="Label15" Text="ЦЕНА:" runat="server" Width="7%" Font-Bold="true" Font-Size="Medium" />
                            <asp:TextBox ID="TxtZen" Width="10%" Height="20" runat="server" Style="position: relative; font-weight: 700; font-size: medium;" />
                            
                            <asp:Label ID="Label16" Text="НА ДОМУ:" runat="server" Width="10%" Font-Bold="true" Font-Size="Medium" />
                            <asp:TextBox ID="TxtZenDom" Width="10%" Height="20" runat="server" Style="position: relative; font-weight: 700; font-size: medium;" />
                            
                            <asp:Label ID="Label3" Text="АКЦИЯ (%):" runat="server" Width="13%" Font-Bold="true" Font-Size="Medium" />
                            <asp:TextBox ID="TxtAkz" Width="5%" Height="20" runat="server" Style="position: relative; font-weight: 700; font-size: medium;" />
                        </span>
                   </td>
                </tr>
