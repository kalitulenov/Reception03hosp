<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MsrMain.Master" AutoEventWireup="true" CodeBehind="SprKdrEdu.aspx.cs" Inherits="Reception03hosp45.Spravki.SprKdrEdu" %>
  ...
  --%>      
            <div class="super-form">
                         <obout:Grid id="grid2" runat="server" 
		                      	...
		                      	<Columns>
	                    			<obout:Column ID="Column21" DataField="EDUIDN" HeaderText="Идн" Visible="false" />											
	                    			<obout:Column ID="Column22" DataField="EDUDIPDAT" HeaderText="Дата диплома" Width="110" DataFormatString = "{0:dd/MM/yy}" >
	            			        	   <TemplateSettings EditTemplateId="tplDatePicker0" />
	            			        </obout:Column>
	            			        <obout:Column ID="Column23" DataField="EDUNAM" HeaderText="Учебное заведение" Width="500" />
