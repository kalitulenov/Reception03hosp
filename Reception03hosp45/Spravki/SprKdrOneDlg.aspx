...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sdsDlg.SelectCommand = "SELECT DLGKOD AS KOD,DLGNAM AS NAM FROM SPRDLG ORDER BY DLGNAM";
    ...
    void GetGrid()
    {
        ...
        con.Open();
        // создание команды
        SqlCommand cmd = new SqlCommand("SELECT KDRDLG.*,SPRDLG.DLGNAM AS NAM " +
                                        "FROM KDR INNER JOIN KDRDLG ON KDR.KDRKOD=KDRDLG.KOD " +
                                                 "INNER JOIN SPRDLG ON KDRDLG.DLGKOD=SPRDLG.DLGKOD WHERE KDRKOD=" + KdrKod, con);
    ...
    {
        DlgDat = Convert.ToString(e.Record["DLGDAT"]);
        DlgKod = Convert.ToInt32(e.Record["DLGKOD"]);
        DlgMem = Convert.ToString(e.Record["DLGMEM"]);
        ...
        // создание команды
        SqlCommand cmd = new SqlCommand("INSERT INTO KDRDLG (KOD,DLGKOD,DLGDAT,DLGMEM) " +
                                        "VALUES (@KOD,@DLGKOD,CONVERT(DATETIME,@DLGDAT,103),@DLGMEM)", con);
        //   cmd = new SqlCommand("BuxSprKdrAdd", con);
        // указать тип команды
        //      cmd.CommandType = CommandType.StoredProcedure;
        // создать коллекцию параметров

        cmd.Parameters.Add("@KOD", SqlDbType.VarChar).Value = KdrKod;
        cmd.Parameters.Add("@DLGDAT", SqlDbType.VarChar).Value = DlgDat;
        cmd.Parameters.Add("@DLGKOD", SqlDbType.VarChar).Value = DlgKod;
        cmd.Parameters.Add("@DLGMEM", SqlDbType.VarChar).Value = DlgMem;
    ...
    {
        DlgIdn = Convert.ToInt32(e.Record["DLGIDN"]);
        DlgDat = Convert.ToString(e.Record["DLGDAT"]);
        DlgMem = Convert.ToString(e.Record["DLGMEM"]);
        DlgKod = Convert.ToInt32(e.Record["DLGKOD"]);
        ...
        // создание команды
        SqlCommand cmd = new SqlCommand("UPDATE KDRDLG SET DLGDAT=CONVERT(DATETIME,@DLGDAT,103),DLGKOD=@DLGKOD,DLGMEM=@DLGMEM WHERE DLGIDN=@DLGIDN", con);
        //   cmd = new SqlCommand("BuxSprKdrAdd", con);
        // указать тип команды
        //      cmd.CommandType = CommandType.StoredProcDlgre;
        // создать коллекцию параметров

        cmd.Parameters.Add("@DLGIDN", SqlDbType.VarChar).Value = DlgIdn;
        cmd.Parameters.Add("@DLGDAT", SqlDbType.VarChar).Value = DlgDat;
        cmd.Parameters.Add("@DLGKOD", SqlDbType.VarChar).Value = DlgKod;
        cmd.Parameters.Add("@DLGMEM", SqlDbType.VarChar).Value = DlgMem;
        // ------------------------------------------------------------------------------заполняем второй уровень
    ...
    void DeleteRecord(object sender, GridRecordEventArgs e)
    {
        ...
        // создание команды
        SqlCommand cmd = new SqlCommand("DELETE FROM KDRDLG WHERE DLGIDN=@DLGIDN", con);
        //   cmd = new SqlCommand("BuxSprKdrAdd", con);
        // указать тип команды
       // cmd.CommandType = CommandType.StoredProcedure;
        // создать коллекцию параметров
        ...
        <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double"
            ...
            <asp:TextBox ID="BoxTit"
             ...
             <obout:Grid ID="GridKdr" runat="server"
                ...
                <Columns>
                    <obout:Column ID="Column00" DataField="DLGIDN" HeaderText="ИДН" Width="0%" Visible="false" />
                    <obout:Column ID="Column01" DataField="DLGDAT" HeaderText="ДАТА" DataFormatString="{0:dd.MM.yyyy}" ApplyFormatInEditMode="true" Width="10%" />
                    <obout:Column ID="Column02" DataField="DLGKOD" HeaderText="ДОЛЖНОСТЬ" Width="50%" >
                        <TemplateSettings TemplateId="TemplateDlgNam" EditTemplateId="TemplateEditDlgNam" />
                    </obout:Column>
                    <obout:Column ID="Column03" DataField="DLGMEM" HeaderText="ПРИМЕЧАНИЕ" Width="30%" />
                ...
                <Templates>
                    ...
                    <obout:GridTemplate runat="server" ID="TemplateEditDlgNam" ControlID="ddlDlgNam" ControlPropertyName="value">
                        <Template>
                            <asp:DropDownList ID="ddlDlgNam" runat="server" AppendDataBoundItems="True" Width="99%" DataSourceID="sdsDlg" CssClass="ob_gEC" DataTextField="NAM" DataValueField="KOD">
