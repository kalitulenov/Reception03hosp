...
{
    public partial class DocAppStz : System.Web.UI.Page
    {
        //        Grid Grid1 = new Grid();
   ...
   //         AmbCrdIdn = (string)Session["AmbCrdIdn"];
       ...
       //     Session.Add("AmbCrdIdn", AmbCrdIdn);
            ...
            if (!Page.IsPostBack)
            {
                ...
                TextBoxNum.Attributes.Add("onchange", "onChange('ctl00$MainContent$TextBoxNum',ctl00$MainContent$TextBoxNum.value);");
