<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MsrMain.Master" AutoEventWireup="true" CodeBehind="DocAppAmbKrd.aspx.cs" Inherits="Reception03hosp45.Priem.DocAppAmbKrd" %>
...
*/
 ...
 //            document.getElementById('MainContent_mySpl_ctl00_ctl01_ButtonArxAmb').style.fontWeight = '';
             ...
             if (BuxFrm == "1") mySpl.loadPage("BottomContent", "DocAppAmbPrsGos.aspx?AmbCrdIdn=" + AmbCrdIdn);
      ...
      //       alert("onChange=");
       //      alert("sender=" + sender + "  " + newText);
         ...
         function FindKlt() {
             var ua = navigator.userAgent;
             if (ua.search(/Chrome/) > -1)
                 window.open("/Referent/RefGlv003Klt.aspx?TextBoxFio=" + document.getElementById('MainContent_TextBoxFio').value, "ModalPopUp","toolbar=no,width=1200,height=560,left=100,top=50,location=no,modal=1,status=no,scrollbars=no,resize=no,fullscreen=yes");             else
                 window.showModalDialog("/Referent/RefGlv003Klt.aspx?TextBoxFio=" + document.getElementById('MainContent_TextBoxFio').value, "ModalPopUp", "center:yes;resizable:yes;status:no;dialogleft:100px;dialogtop:50px;dialogWidth:1200px;dialogHeight:560px;");
         }
       ...
       //       var hashes = result.split('&');
         ...
         function ConfirmBeforeDeleteOnClick() {      
             ...
             document.getElementById('MainContent_TextBoxFrm').value = hashes[6];
       ...
       <obspl:HorizontalSplitter ID="mySpl" CookieDays="0" runat="server" IsResizable="false" StyleFolder="~/Styles/Splitter">   
			    <TopPanel HeightMin="20" HeightMax="400" HeightDefault="23">
				    <Content>
                     ...
                     <asp:Button ID="ButtonUsl" runat="server" Width="7%" CommandName="Push" Text="Услуги и диагнозы" OnClientClick="UslButton_Click(); return false"/>
                     ...
                     <asp:Button ID="Button095" runat="server" Width="7%" CommandName="Push" Text="095/у" OnClientClick="S95Button_Click(); return false"/>
