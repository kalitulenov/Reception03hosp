...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
   //         alert(rowIndex + ' = ' + cellIndex + ' ' + GridFun.Rows[rowIndex].Cells[0].Value);
            var AmbLabIdn = GridFun.Rows[rowIndex].Cells[0].Value;
  //          alert("AmbLabIdn=" + AmbLabIdn);

            if (cellIndex == 4 && GridFun.Rows[rowIndex].Cells[4].Value == "+") {
            ...
            if (cellIndex == 5 && GridFun.Rows[rowIndex].Cells[5].Value == "+") {
                var ua = navigator.userAgent;
                if (ua.search(/Chrome/) > -1)
            ...
            if (cellIndex == 6 && GridFun.Rows[rowIndex].Cells[6].Value == "+") {
                var ua = navigator.userAgent;
                if (ua.search(/Chrome/) > -1)
...
//        AmbCrdIdn = (string)Session["AmbCrdIdn"];
    ...
    void getGrid()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("HspAmbUziXryIdn", con);
        // указать тип команды
        ...
        da.Fill(ds, "HspAmbUziXryIdn");

        con.Close();
        
        GridFun.DataSource = ds;
        GridFun.DataBind();
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="Vertical"
            ...
            <%-- ============================  шапка экрана ============================================ --%>
            <obout:Grid ID="GridFun" runat="server"
                CallbackMode="true"
                Serialize="true"
                ...
                <Columns>
                    ...
                    <obout:Column ID="Column3" DataField="USLNAM" HeaderText="ИССЛЕДОВАНИЯ" Width="81%" />
                    <obout:Column ID="Column4" DataField="USLUZI" HeaderText="ФУНК.ДИАГ" Width="5%" Align="center" /> 
                    <obout:Column ID="Column5" DataField="USLXRY" HeaderText="." Width="2%" />
                    <obout:Column ID="Column6" DataField="USLFNK" HeaderText="." Width="2%" />
                    <obout:Column ID="Column7" DataField="USLBINGDE" HeaderText="ГДЕ ПРОВЕД" Width="10%" />
                </Columns>
            </obout:Grid>
        </asp:Panel>
<%-- ============================  нижний блок   ExposeSender="true" ============================================ --%>
  <%-- ============================  для отображение графика врачей на один день в виде окна geryon============================================ --%>
    <owd:Window ID="LabWindow" runat="server"  Url="" IsModal="true" ShowCloseButton="true" Status=""
        Left="200" Top="10" Height="500" Width="1000" Visible="true" VisibleOnLoad="false"
