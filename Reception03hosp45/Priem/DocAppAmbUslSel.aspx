...
<head id="Head1" runat="server">
    ...
    <script runat="server">
        ...
        void PopulateGridUsl()
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("HspAmbUslSelFin", con);
            cmd = new SqlCommand("HspAmbUslSelFin", con);
            ...
            TxtPrk.Text = Convert.ToString(ds.Tables[0].Rows[0]["PRKHSP"]);
            TxtDsp.Text = Convert.ToString(ds.Tables[0].Rows[0]["DSPMKB"]);
        ...
        protected void UslButtonOK_Click(object sender, EventArgs e)
        {
            //KltIin = Convert.ToString(parKltIin.Value);

            if (GridUsl.SelectedRecords != null)
            {
                string selectedUsl = "СТАТУС:"+TxtSts.Text+", ПРИКРЕПЛЕН:"+TxtPrk.Text+", ПОВОД.ОБР:"+TxtPvd.Text+
                                     ", ДИАГНОЗ:"+TxtDig.Text+", СОЦ.ЗАЩ.:"+TxtSoz.Text+", ДИСПАНСЕР.:"+TxtDsp.Text+"&";
                //=====================================================================================
                foreach (Hashtable oRecord in GridUsl.SelectedRecords)
                {
                    selectedUsl += Convert.ToString(oRecord["TRFKPN"])+"."+Convert.ToString(oRecord["FINKOD"])+"."+Convert.ToInt32(oRecord["USLKOD"]).ToString("D10")+"&";
                }
                ...
                // создание команды
                SqlCommand cmd = new SqlCommand("HspAmbUslSelFinAdd", con);
                // указать тип команды
                cmd.CommandType = CommandType.StoredProcedure;
                // передать параметр
                cmd.Parameters.Add("@USLAMB", SqlDbType.Int, 4).Value = AmbCrdIdn;
                cmd.Parameters.Add("@USLKODLST", SqlDbType.VarChar).Value = selectedUsl;
                try
                {
                    ...
                    <tr>
                       <tr>
                          <td style="width: 100%; height: 30px;">
                               ...
                               <asp:TextBox ID="TxtSts" Width="40%" Height="20" runat="server" Style="position: relative; font-weight: 600; font-size: medium;" />
                               <asp:Label ID="Label4" Text="ПРИКРЕПЛЕН:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                               <asp:TextBox ID="TxtPrk" Width="23%" Height="20" runat="server" Style="position: relative; font-weight: 600; font-size: medium;" />
                          </td>
                       </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td style="width: 100%; height: 30px;">
                            ...
                            <asp:TextBox ID="TxtSoz" Width="40%" Height="20" runat="server" Style="position: relative; font-weight: 600; font-size: medium;" />
                            <asp:Label ID="Label6" Text="ДИСПАНСЕР.:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                            <asp:TextBox ID="TxtDsp" Width="23%" Height="20" runat="server" Style="position: relative; font-weight: 600; font-size: medium;" />
                      </td>
                    </tr>
...
<%--			        <Templates>
        ...
        <%-- ============================  нижний блок   ExposeSender="true" ============================================ --%>
          <asp:Panel ID="PanelBot" runat="server" BorderStyle="Double" Style="left: 0px; position: relative; top: 0px; width: 100%; height: 30px;">
                <center>
                    <asp:Button ID="RefButton" runat="server" CommandName="Add" Text="Записать" OnClick="UslButtonOK_Click" />
                </center>
          </asp:Panel> 
