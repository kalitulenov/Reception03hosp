...
<body>
    <form id="form1" runat="server">
       ...
       <%-- ============================  для передач значении  ============================================ --%>
        ...
        <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double"
            ...
            <table border="0" cellspacing="0" width="100%" cellpadding="0">
                <tr>
                    <td style="width: 95%">
                     <asp:Label id="Label1" Text="СТРАХОВ:" runat="server"  Width="18%" Font-Bold="true" /> 
                    ...
                    <td style="width: 5%" rowspan="2">
                       <button id="Swo1" onclick="WebCam();"><img id="img11" src="/Icon/webcam.png" alt="Start"></button>
                    </td>
                </tr>
                <tr>
                    <td style="width: 95%">
                       <asp:Label id="Label6" Text="УСЛУГА:" runat="server" Height="25"  Width="18%" Font-Bold="true" /> 
                       <obout:ComboBox runat="server"
                            AutoPostBack="true"
                            ID="BoxUsl"
                            Width="70%"
       ...
       <asp:Panel ID="Panel1" runat="server" BorderStyle="Double"
            Style="left: 0px; position: relative; top: -10px; width: 100%; height: 440px;">
        <table border="0" cellspacing="0" width="100%" cellpadding="0">
 <!--  Нозология ----------------------------------------------------------------------------------------------------------  -->    
                         ...
                         <tr style="height:40px">                             
                            <td width="10%" style="vertical-align: top;">
                             ...
                             <td width="88%" style="vertical-align: top;">
                                 <asp:TextBox ID="Dig003" Width="99%" Height="40" runat="server" TextMode="MultiLine" Style="position: relative; font-weight: 700; font-size: medium;" />
                            </td>
                        </tr>
 <!--  Описание----------------------------------------------------------------------------------------------------------  -->
                         <tr style="height:80px">                            
                            <td width="10%" style="vertical-align: top;">
                             ...
                             <td width="81%" style="vertical-align: top;">
                                 <asp:TextBox ID="Ops003" Width="99%" Height="120" runat="server" TextMode="MultiLine" Style="position: relative; font-weight: 700; font-size: medium;" />
                            </td>
 ...
 <!--  Заключения ----------------------------------------------------------------------------------------------------------  -->  
                         <tr>                            
                            ...
                            <td width="81%" style="vertical-align: top;">
                                 <asp:TextBox ID="Zak003" Width="99%" Height="120" runat="server" TextMode="MultiLine" Style="position: relative; font-weight: 700; font-size: medium;" />
                            </td>
                            <td style="vertical-align: top; width:7%" >
 ...
 <!--  Рекомендации ----------------------------------------------------------------------------------------------------------  -->  
                         <tr>                            
                            ...
                            <td width="88%" style="vertical-align: top;">
                                 <asp:TextBox ID="Rek003" Width="99%" Height="120" runat="server" TextMode="MultiLine" Style="position: relative; font-weight: 700; font-size: medium;" />
                            </td>
                            <td style="vertical-align: top; width:7%" >
