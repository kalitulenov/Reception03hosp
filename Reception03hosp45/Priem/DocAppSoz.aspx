      ...
      <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" 
            ...
            <obout:Grid ID="GridUsl" runat="server"
                ...
                <Columns>
                    ...
                    <obout:Column ID="Column06" DataField="STXKEY" HeaderText="ВИД ОПЛ" Width="8%">
                    ...
                    <obout:Column ID="Column11" DataField="USLMEM" HeaderText="ПРИМЕЧАНИЕ" Width="43%" Wrap="true" Align="right" />
