<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MsrMain.Master" AutoEventWireup="true" CodeBehind="DocAppAmbAcm.aspx.cs" Inherits="Reception03hosp45.Priem.DocAppAmbAcm" %>
...
/*
  ...
  //           alert("AmbCrdIdn=" + AmbCrdIdn);
      ...
      //       document.getElementById('MainContent_mySpl_ctl00_ctl01_ButtonOsm').style.fontWeight = 'bold';
             ...
             mySpl.loadPage("BottomContent", "DocAppAmbOsmAcm.aspx?AmbCrdIdn=" + AmbCrdIdn);
         };
...
*/
 ...
 //            alert("SqlStr=" + SqlStr);
      ...
      //                  alert("PrtRzpButton=");
         ...
         //    ==========================  ПЕЧАТЬ НАПРАВЛЕНИЯ ПО ОДНОЙ=============================================================================================
         function PrtNapButtonOne_Click() {
             var AmbCrdIdn = document.getElementById('MainContent_HidAmbCrdIdn').value;
      //         alert("PrtNapButton=");
           var ua = navigator.userAgent;
         ...
         //    ==========================  ПЕЧАТЬ НАПРАВЛЕНИЯ ВСЕХ=============================================================================================
         function PrtNapButtonAll_Click() {
             var AmbCrdIdn = document.getElementById('MainContent_HidAmbCrdIdn').value;
    //          alert('PrtNapButtonAll= ' );
            var ua = navigator.userAgent;
  ...
  <asp:Panel ID="PanelTop" runat="server" BorderStyle="None"  
      ...
      <table border="1" cellspacing="0" width="100%">
               <tr>
                  ...
                  <td width="12%" align="center" style="font-weight:bold; background-color:yellow" class="PO_RowCap">КАССА</td>
              </tr>
  ...
  <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="None" 
       ...
       <obspl:HorizontalSplitter ID="mySpl" CookieDays="0" runat="server" IsResizable="false" StyleFolder="~/Styles/Splitter">   
			    <TopPanel HeightMin="20" HeightMax="400" HeightDefault="23">
				    <Content>
                     <asp:Button ID="ButtonOsm" runat="server" Height="20px" Width="6%" CommandName="Push" Text="Осмотр" OnClientClick="OsmButton_Click(); return false;"/>
                     <asp:Button ID="ButtonLoc" runat="server" Height="20px" Width="6%" CommandName="Push" Text="Статус" OnClientClick="LocButton_Click(); return false;"/>
                     <asp:Button ID="ButtonUkl" runat="server" Height="20px" Width="8%" CommandName="Push" Text="В проц.каб." OnClientClick="UklButton_Click(); return false"/>
                     <asp:Button ID="ButtonBol" runat="server" Height="20px" Width="7%" CommandName="Push" Text="Бол.лист" OnClientClick="BolButton_Click(); return false"/>
                     <asp:Button ID="ButtonSpr" runat="server" Height="20px" Width="7%" CommandName="Push" Text="095/у" OnClientClick="StfButton_Click(); return false"/>
                     <asp:Button ID="ButtonLab" runat="server" Height="20px" Width="7%" CommandName="Push" Text="Лаб.анал." OnClientClick="LabButton_Click(); return false"/>
                     <asp:Button ID="ButtonUzi" runat="server" Height="20px" Width="8%" CommandName="Push" Text="Функ.диагн." OnClientClick="UziXryButton_Click(); return false"/>
                     <asp:Button ID="ButtonDig" runat="server" Height="20px" Width="7%" CommandName="Push" Text="Диагнозы" OnClientClick="DigButton_Click(); return false"/>
                     <asp:Button ID="ButtonScr" runat="server" Height="20px" Width="7%" CommandName="Push" Text="Скрининг" OnClientClick="ScrButton_Click(); return false"/>
                     <asp:Button ID="ButtonTlk" runat="server" Height="20px" Width="7%" CommandName="Push" Text="Форум" OnClientClick="TlkButton_Click(); return false"/>
				    </Content>
			    </TopPanel>
...
<%-- ============================  нижний блок   ExposeSender="true" ============================================ --%>
  <asp:Panel ID="PanelBot" runat="server" BorderStyle="Double" 
             ...
             <center>
                 ...
                 <input type="button" value="Печать направления по одному"  onclick="PrtNapButtonOne_Click()" />
                 <input type="button" value="Печать направления"  onclick="PrtNapButtonAll_Click()" />
