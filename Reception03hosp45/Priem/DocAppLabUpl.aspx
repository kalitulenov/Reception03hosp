<%@ Page Language="C#" MasterPageFile="~/Masters/MsrMain.Master" AutoEventWireup="true" CodeBehind="DocAppLabUpl.aspx.cs" Inherits="Reception03hosp45.Priem.DocAppLabUpl" Title="Безымянная страница" %>
 ...
 <script type="text/javascript">
  ...
  //       alert("ConfirmBeforeDeleteOnClick=" + document.getElementById('myConfirmBeforeDeleteHidden').value);
     ...
     function OnClientSelect(sender, selectedRecords) {
         ...
         switch (GlvDocTyp) {
             case 'Л01': location.href = "/Priem/DocAppLabUpl001.aspx?GlvDocIdn=" + GlvDocIdn; break;
         }
...
<%-- ============================  верхний блок  ============================================ --%>
  ...
  <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double" 
             Style="left: 30%; position: relative; top: 0px; width: 40%; height: 30px;">
...
<%-- ============================  средний блок  ============================================ --%>
   <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="Vertical"
             Style="left: 30%; position: relative; top: 0px; width: 40%; height: 500px;">
	        ...
	        <obout:Grid id="GridDoc" runat="server" 
                ...
                <Columns>
	                ...
	                <obout:Column ID="Column4" DataField="DOCMEM" HeaderText="Пациент" Width="50%" Align="left" />
	                <obout:Column ID="Column5" DataField="DOCKOL" HeaderText="Кол-во" Width="10%" Align="center" />
	                <obout:Column ID="Column6" DataField="BUX" HeaderText="Ответст." Width="15%" />
		            <obout:Column ID="Column7" DataField="" HeaderText="Корр" Width="6%" AllowEdit="false" AllowDelete="true" runat="server" />
		        </Columns>
           	</obout:Grid>
  </asp:Panel> 
