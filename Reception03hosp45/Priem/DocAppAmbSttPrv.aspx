 ...
 //               filComboBox();
  ...
  //          string name = value ?? string.Empty;
        ...
        protected void TmpButton_Click(object sender, EventArgs e)
        {
            ...
            // передать параметр
            cmd.Parameters.Add("@GLVDOCIDN", SqlDbType.VarChar).Value = AmbCrdIdn;
            cmd.Parameters.Add("@GLVTYP", SqlDbType.VarChar).Value = "PRV";
            // Выполнить команду
            con.Open();
                        ...
                        <tr> 
                            ...
                            <td width="3%" style="vertical-align: top;">
                             ...
                             <td width="91%" style="vertical-align: top;" >
                                 <obout:OboutTextBox runat="server" ID="StsGnr003"  width="100%" BackColor="White" Height="40px"
 ...
 <!-- Кожные покровы:  ----------------------------------------------------------------------------------------------------------  -->
                         <tr>                            
                            ...
                            <td width="3%" style="vertical-align: top;">
                             ...
                             <td width="91%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="StsKoz003"  width="100%" BackColor="White" Height="40px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>
                         ...
                         <tr>                            
                            ...
                            <td width="3%" style="vertical-align: top;">
                                <asp:Button ID="StsKst002" runat="server"
                                    Width="100%" CommandName="" CommandArgument=""
                                    Text="Зев:" Height="30px"
                                    Style="position: relative; top: 0px; left: 0px" />
                            </td>
                             <td width="91%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="StsKst003"  width="100%" BackColor="White" Height="40px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>
                         ...
                         <tr> 
                            ...
                            <td width="3%" style="vertical-align: top;">
                                <asp:Button ID="StsSrd002" runat="server"
                                    Width="100%" CommandName="" CommandArgument=""
                                    Text="Сердечные тоны:" Height="30px"
                                    Style="position: relative; top: 0px; left: 0px" />
                            </td>
                             <td width="91%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="StsSrd003"  width="100%" BackColor="White" Height="40px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>
                         ...
                         <tr> 
                            ...
                            <td width="3%" style="vertical-align: top;">
                                <asp:Button ID="StsDix002" runat="server"
                                    Width="100%" CommandName="" CommandArgument=""
                                    Text="Легкие:  " Height="30px"
                                    Style="position: relative; top: 0px; left: 0px" />
                            </td>
                             <td width="91%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="StsDix003"  width="100%" BackColor="White" Height="40px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>
                         ...
                         <tr>                            
                            ...
                            <td width="3%" style="vertical-align: top;">
                                <asp:Button ID="StsJkt002" runat="server"
                                    Width="100%" CommandName="" CommandArgument=""
                                    Text="ЖКТ: " Height="30px"
                                    Style="position: relative; top: 0px; left: 0px" />
                            </td>
                             <td width="91%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="StsJkt003"  width="100%" BackColor="White" Height="40px" 
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>                     
                         ...
                         <tr>                            
                            ...
                            <td width="3%" style="vertical-align: top;">
                                <asp:Button ID="StsNer002" runat="server"
                                    Width="100%" CommandName="" CommandArgument=""
                                    Text="Стул: " Height="30px"
                                    Style="position: relative; top: 0px; left: 0px" />
                            </td>
                             <td width="91%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="StsNer003"  width="100%" BackColor="White" Height="40px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>
                         ...
                         <tr>                             
                            ...
                            <td width="3%" style="vertical-align: top;">
                                <asp:Button ID="StsMch002" runat="server"
                                    Width="100%" CommandName="" CommandArgument=""
                                    Text="Мочеиспускание: " Height="30px"
                                    Style="position: relative; top: 0px; left: 0px" />
                            </td>
                             <td width="91%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="StsMch003"  width="100%" BackColor="White" Height="40px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                             </td>
