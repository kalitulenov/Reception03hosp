    ...
    //     if (ua.search(/OPR/) > -1) h = h + 100;
     //   alert("AmbCntIdn = " + AmbCntIdn + " & GlvDocTyp=" + GlvDocTyp);
         ...
         switch (GlvDocTyp) {
             ...
             case 'СМП': location.href = "/Priem/DocApp003.aspx?AmbCrdIdn=0&AmbCntIdn=" + AmbCntIdn + "&GlvDocTyp=" + GlvDocTyp; break;
 ...
 //        alert("ConfirmBeforeDeleteOnClick=" + document.getElementById('myConfirmBeforeDeleteHidden').value);
     ...
     function OnClientSelect(sender, selectedRecords) {
         ...
         switch (GlvDocTyp) {
             ...
             case 'СМП': location.href = "/Priem/DocApp003.aspx?AmbCrdIdn=" + AmbCrdIdn + "&AmbCntIdn=&GlvDocTyp=" + GlvDocTyp; break;
