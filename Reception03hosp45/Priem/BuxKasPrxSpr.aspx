    ...
    <script runat="server">
        ...
        void WriteKas(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GridUsl.RowsInViewState.Count; i++)
            {
               ...
               //         string DocKod = Convert.ToString(GridUsl.FindControl("BuxUslDocKod"));
//
 //                       GridDataControlFieldCell cellDoc = GridUsl.RowsInViewState[i].Cells[1] as GridDataControlFieldCell;
  //                      String DocKod = Convert.ToString(cellDoc.FindControl("BuxUslDocKod")) as String;
   //                     selectedDocKod += DocKod;
                }
            }
            ...
            if (!string.IsNullOrEmpty(selectedOrderIds))
            {
                ...
                con.Open();
                //=====================================================================================
                SqlCommand cmd = new SqlCommand("HspSprUslDocKas", con);
                cmd = new SqlCommand("HspSprUslDocKas", con);
                cmd.CommandType = CommandType.StoredProcedure;
                //=====================================================================================

                //        BuxUsl = Convert.ToInt32(oRecord["USLKOD"]);
            //    BuxKod = Convert.ToInt32(parBuxKod.Value);
            //    BuxKod = Convert.ToInt32(oRecord["USLKOD"]);
              //  BuxUslDocKod

                cmd.Parameters.Add("@BUXSID", SqlDbType.VarChar).Value = BuxSid;
                cmd.Parameters.Add("@BUXFRM", SqlDbType.Int, 4).Value = BuxFrm;
//                cmd.Parameters.Add("@DOCKODLST", SqlDbType.VarChar).Value = selectedDocKod;  // BuxKod;
