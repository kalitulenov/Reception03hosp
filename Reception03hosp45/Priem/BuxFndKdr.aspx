...
<head id="Head1" runat="server">
 ...
 //           alert("OnClientDblClick=" + iRecordIndex);
            var GrfIin = "KDR&" + GridKdr.Rows[iRecordIndex].Cells[1].Value + "&" + GridKdr.Rows[iRecordIndex].Cells[2].Value;
 //           var GrfFio = GridKdr.Rows[iRecordIndex].Cells[1].Value+"&"+GridKdr.Rows[iRecordIndex].Cells[2].Value+"&"+GridKdr.Rows[iRecordIndex].Cells[3].Value.substring(0,8) +"&"+
 //                        GridKdr.Rows[iRecordIndex].Cells[5].Value+"&"+GridKdr.Rows[iRecordIndex].Cells[6].Value+"&"+GridKdr.Rows[iRecordIndex].Cells[7].Value+"&"+
 //                        GridKdr.Rows[iRecordIndex].Cells[9].Value+"&"+GridKdr.Rows[iRecordIndex].Cells[8].Value+"&"+GridKdr.Rows[iRecordIndex].Cells[10].Value.substring(0,8);
 //           alert("GrfIin=" + GrfIin);
        ...
        function OnClientSelect(selectedRecords) {
            ...
            var GrfIin = "KDR&" + selectedRecords[0].BUXKOD + "&" + selectedRecords[0].FIO;
            //          alert("GrfIin=" + GrfIin);
            localStorage.setItem("FndIin", GrfIin); //setter
            window.opener.HandlePopupResult(GrfIin);
            self.close();
...
//                Cond = Cond + "%";
    ...
    void getGrid(string Cond)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("BuxFndKdr", con);
        // указать тип команды
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="Vertical"
            ...
            <obout:Grid ID="GridKdr" runat="server"
                ...
                <Columns>
                    <obout:Column ID="Column00" DataField="BUXTAB" HeaderText="Идн" Visible="false" Width="0%"/>
                    <obout:Column ID="Column01" DataField="BUXKOD" HeaderText="Код" Visible="false" Width="0%" />
                    <obout:Column ID="Column02" DataField="FIO" HeaderText="ФИО" Width="50%" />
                    <obout:Column ID="Column03" DataField="DLGNAM" HeaderText="ДОЛЖНОСТЬ" Width="20%" />
                    <obout:Column ID="Column04" DataField="KDRIIN" HeaderText="ИИН" Width="20%" />
                    <obout:Column ID="Column05" DataField="BUXUBL" HeaderText="Удл" Width="10%" />
              </Columns>
