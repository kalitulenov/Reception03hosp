 ...
 //                      alert("GridUsl_ClientInsert");
   ...
   //          var BuxFrm = document.getElementById('parBuxFrm').value;
             ...
             if (ua.search(/Chrome/) > -1)
                 window.open("/Priem/BuxKasPrxSprStz.aspx?AmbCrdIdn=" + document.getElementById("parCrdIdn").value, 
                 ...
                 window.showModalDialog("/Priem/BuxKasPrxSprStz.aspx?AmbCrdIdn=" + document.getElementById("parCrdIdn").value,
...
*/
    ...
    void getGrid()
    {
        ...
        SqlConnection con = new SqlConnection(connectionString);
        con.Open();
        SqlCommand cmd = new SqlCommand("HspAmbUslStxIin", con);
        // указать тип команды
        cmd.CommandType = CommandType.StoredProcedure;
        // передать параметр
        ...
        <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="Vertical"
            ...
            <obout:Grid ID="GridUsl" runat="server"
                ...
                <Columns>
                    ...
                    <obout:Column ID="Column02" DataField="KASNUM" HeaderText="КАССА" Width="5%" ReadOnly="true" />
                    <obout:Column ID="Column03" DataField="KASDAT" HeaderText="ДАТА" DataFormatString = "{0:dd.MM.yyyy}" Width="5%" />
                    <obout:Column ID="Column04" DataField="CNTNAM" HeaderText="ВИД ОПЛ" Width="5%" />
                    <obout:Column ID="Column05" DataField="USLNAM" HeaderText="НАИМЕНОВАНИЕ УСЛУГИ" Width="35%" Align="left" />
                    <obout:Column ID="Column06" DataField="USLZEN" HeaderText="ЦЕНА" Width="5%" ReadOnly="true" Align="right" />
                    <obout:Column ID="Column07" DataField="USLMEM" HeaderText="НОМЕР" Width="5%" ReadOnly="true" Align="right" />
                    <obout:Column ID="Column08" DataField="USLKOL" HeaderText="КОЛ-ВО" Width="5%" ReadOnly="true" Align="right" />
                    <obout:Column ID="Column09" DataField="USLLGT" HeaderText="ЛЬГОТА" Width="5%" />

                    <obout:Column ID="Column10" DataField="USLSUM" HeaderText="СУММА" Width="5%" ReadOnly="true" />
                    <obout:Column ID="Column11" DataField="USLKTO" HeaderText="ОТВЕТСТВЕННЫЙ" Width="10%" >
                    ...
                    <obout:Column ID="Column12" DataField="RSXFLG" HeaderText="РАСХОД" Width="5%" ReadOnly="true" >
