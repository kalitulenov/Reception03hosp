 ...
 //                 alert("SqlStr=" + SqlStr);
  ...
  //                  break;
                ...
                case 'BoxEdn':
                    ...
                    break;
 //               case 'BoxNaz':
 //                   DatDocVal = BoxNaz.options[BoxNaz.selectedIndex()].value;
 //                   SqlStr = "UPDATE AMBNAZ SET NAZKOD=" + DatDocVal + ",NAZPLNOBS=(SELECT MATNAM FROM TABMAT WHERE MATKOD=" + DatDocVal + ") WHERE NAZIDN=" + DatDocIdn;
  //                  break;
                default:
                    break;
            }
...
//            BoxNaz.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["NAZKOD"]);
    ...
    <form id="form1" runat="server">
       ...
       <%-- ============================  для передач значении  ============================================ --%>
        ...
        <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double"
            Style="left: 0px; position: relative; top: -10px; width: 100%; height: 300px;">

            <table border="0" cellspacing="0" width="100%" cellpadding="0">
                <tr>
                    <td style="width: 100%; height: 30px;"">
                        <asp:Label ID="Label2" Text="НАЗНАЧЕНИЕ:" runat="server" Width="25%" Font-Bold="true" Font-Size="Medium" />
                        <asp:TextBox ID="TxtNaz" Width="70%" Height="20" runat="server" Style="position: relative; font-weight: 700; font-size: medium;" />
                   </td>
                </tr>
