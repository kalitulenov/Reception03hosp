...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GridBol_ClientEdit(sender, record) {
            ...
            BolWindow.setUrl("DocAppAmb095One.aspx?AmbBolIdn=" + AmbBolIdn + "&AmbCrdIdn=" + AmbCrdIdn + "&AmbRej=0");
            BolWindow.Open();
        ...
        function GridBol_ClientInsert(sender, record) {
          ...
          //  alert("AmbCrdIdn=" + AmbCrdIdn);
            ...
            BolWindow.setTitle(AmbBolIdn);
            BolWindow.setUrl("DocAppAmb095One.aspx?AmbBolIdn=0&AmbCrdIdn=" + AmbCrdIdn + "&AmbRej=0");
            BolWindow.Open();
        ...
        <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="Vertical"
            ...
            <obout:Grid ID="GridBol" runat="server"
                ...
                <Columns>
                    ...
                    <obout:Column ID="Column04" DataField="BOLPTH" HeaderText="ПАЦИЕНТ" Width="37%" />
                    <obout:Column ID="Column05" DataField="DOC000" HeaderText="0.ВРАЧ ОТКРЫЛ" Width="10%" />
                    <obout:Column ID="Column06" DataField="BOLBEG000" HeaderText="1.НАЧАЛО" DataFormatString="{0:dd.MM.yyyy}" ApplyFormatInEditMode="true" Width="6%" />
                    <obout:Column ID="Column07" DataField="BOLEND000" HeaderText="1.КОНЕЦ" DataFormatString="{0:dd.MM.yyyy}" ApplyFormatInEditMode="true" Width="6%" />

                    <obout:Column ID="Column08" DataField="BOLEND001" HeaderText="2.НАЧАЛО" DataFormatString="{0:dd.MM.yyyy}" ApplyFormatInEditMode="true" Width="6%" />
                    ...
                    <obout:Column ID="Column10" DataField="BOLEND003" HeaderText="3.НАЧАЛО" DataFormatString="{0:dd.MM.yyyy}" ApplyFormatInEditMode="true" Width="6%" />

                    <obout:Column ID="Column11" DataField="BOLEND009" HeaderText="3.КОНЕЦ" DataFormatString="{0:dd.MM.yyyy}" ApplyFormatInEditMode="true" Width="6%" />

                    <obout:Column ID="Column12" HeaderText="ИЗМ УДЛ" Width="8%" AllowEdit="true" AllowDelete="true" runat="server">
                ...
                <Templates>
       			<obout:GridTemplate runat="server" ID="editBtnTemplate">
                    <Template>
                        <input type="button" id="btnEdit" class="tdTextSmall" value="Изм" onclick="GridBol.edit_record(this)"/>
                ...
                <obout:GridTemplate runat="server" ID="addTemplate">
                    <Template>
                        <input type="button" id="btnAddNew" class="tdTextSmall" value="Открыть справку" onclick="GridBol.addRecord()"/>
                    </Template>
                </obout:GridTemplate>
