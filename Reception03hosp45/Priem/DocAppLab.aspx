...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    //         alert("GridAnl_ClientEdit="+rowIndex);
             ...
             var AmbSblYes = GridUsl.Rows[rowIndex].Cells[2].Value;

    //         alert("AmbSblYes=" + AmbSblYes);

             if (AmbSblYes != "") {
                 var ua = navigator.userAgent;

                 if (ua.search(/Chrome/) > -1) window.open("/Priem/DocAppLabOneAspose.aspx?AmbUslIdn=" + AmbUslIdn, "ModalPopUp", "toolbar=no,width=1300,height=700,left=50,top=50,location=no,modal=1,status=no,scrollbars=no,resize=no,fullscreen=yes");
                 else window.showModalDialog("/Priem/DocAppLabOneAspose.aspx?AmbUslIdn=" + AmbUslIdn, "ModalPopUp", "center:yes;resizable:yes;status:no;dialogleft:50px;dialogtop:50px;dialogWidth:1300px;dialogHeight:700px;");
             }
             else windowalert("Шаблон отсутствует!", "Предупреждения", "warning");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (AmbCrdIdn == "0")  // новый документ
            {
                ...
                cmd.Parameters.Add("@CRDTYP", SqlDbType.VarChar).Value = "ЛАБ";
      ...
      <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" 
            ...
            <obout:Grid ID="GridUsl" runat="server"
                ...
                <Columns>
                    ...
                    <obout:Column ID="Column02" DataField="SBLYESALL" HeaderText="+" Visible="true" Width="5%" />
                    ...
                    <obout:Column ID="Column06" DataField="STXKEY" HeaderText="ВИД ОПЛ" Width="5%">
                        <TemplateSettings TemplateId="TemplateStxNam" EditTemplateId="TemplateEditStxNam" />
                    </obout:Column>
                    <obout:Column ID="Column07" DataField="USLKOD" HeaderText="НАИМЕНОВАНИЕ УСЛУГИ" Width="46%" Align="left">
