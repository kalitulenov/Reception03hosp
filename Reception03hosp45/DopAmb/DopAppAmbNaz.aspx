...
<head id="Head1" runat="server">
  ...
  //          alert("GridNazClose");
        ...
        function SablonNaz() {
            //      alert('SblTyp=' + SblTyp);
            var AmbCrdIdn = document.getElementById('HidAmbCrdIdn').value;
            window.open("DocAppSblNaz.aspx?AmbCrdIdn=" + AmbCrdIdn,"Browser=Desktop", "ModalPopUp", "toolbar=no,width=1000,height=600,left=200,top=100,location=no,modal=yes,status=no,scrollbars=no,resize=no");
        }
