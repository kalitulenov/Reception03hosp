...
//    ==========================  ПЕЧАТЬ =============================================================================================
     function PrtSvdButton_Click() 
     {
         ...
         if (ua.search(/Chrome/) > -1)
             window.open("/Report/DauaReports.aspx?ReportName=HspDocAisSvd&TekDocIdn=" + GrfTyp + "&TekDocKod=" + GrfKod + "&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
             ...
             window.showModalDialog("/Report/DauaReports.aspx?ReportName=HspDocAisSvd&TekDocIdn=" + GrfTyp + "&TekDocKod=" + GrfKod + "&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
...
//    ==========================  ПЕЧАТЬ =============================================================================================
     function PrtSttCrdButton_Click() 
     {
         ...
         var ua = navigator.userAgent;
         if (ua.search(/Chrome/) > -1)
             window.open("/Report/DauaReports.aspx?ReportName=HspDocAisKrt&TekDocKod=" + GrfKod + "&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
                 "ModalPopUp", "toolbar=no,width=900,height=650,left=200,top=100,location=no,modal=1,status=no,scrollbars=no,resize=no,fullscreen=yes");
         else
             window.showModalDialog("/Report/DauaReports.aspx?ReportName=HspDocAisKrt&TekDocKod=" + GrfKod + "&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
                 "ModalPopUp", "center:yes;resizable:yes;status:no;dialogleft:200px;dialogtop:100px;dialogWidth:900px;dialogHeight:650px;");
     }
  ...
  AllowRecordSelection = "true"
               AllowSorting="true"
                ...
                <Columns>
	                ...
	                <obout:Column ID="Column05" DataField="GRFBRT" HeaderText="Д/Р" DataFormatString = "{0:dd/MM/yy}" Width="5%" />
	                ...
	                <obout:Column ID="Column08" DataField="GRFTRF" HeaderText="ТАРИФ"  Width="6%"/>
 	                <obout:Column ID="Column09" DataField="GRFERR" HeaderText="ОШ" Width="5%"/>
	                <obout:Column ID="Column10" DataField="NAMUSL" HeaderText="УСЛУГА" Width="10%" />
	                <obout:Column ID="Column11" DataField="GRFDIG" HeaderText="ДИАГНОЗ" Width="13%" />
	                ...
	                <obout:Column ID="Column17" DataField="AIS" HeaderText="АИС" Width="4%" Align="right"/>
		        </Columns>
...
<%-- ============================  нижний блок   ExposeSender="true" ============================================ --%>
  <asp:Panel ID="PanelBot" runat="server" BorderStyle="Double" 
             Style="left: 2%; position: relative; top: 0px; width: 96%; height: 30px;">
             <center>
                 <input type="button" name="PrtButton" value="Печать свода" id="PrtSvd" onclick="PrtSvdButton_Click();">
