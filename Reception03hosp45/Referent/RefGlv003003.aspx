<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="RefGlv003003.aspx.cs" Inherits="Reception03hosp45.Referent.RefGlv003003" %>
  ...
  //          var GrfOneKod = GridGrf.Rows[iRowIndex].Cells[1].Value;
    ...
    //        alert("GrfOneKod=" + GrfOneKod);
            ...
            if (ua.search(/Chrome/) > -1)
                window.open("/Referent/RefGlvUsl.aspx?AmbCrdIdn=" + GrfOneIdn, "ModalPopUp2", "width=1100,height=480,left=250,top=210,modal=yes,directories=no,toolbar=no,menubar=no,location=no,status=no,scrollbars=no,resizable=no,fullscreen=yes");
            else {
                window.showModalDialog("/Referent/RefGlvUsl.aspx?AmbCrdIdn=" + GrfOneIdn, "ModalPopUp2", "center:yes;resizable:yes;status:no;dialogleft:250px;dialogtop:210px;dialogWidth:1100px;dialogHeight:480px;");
            }
            return false;
