  ...
  //      function GridDeb_ClientUpdate(sender, record) {
   ...
   //     }
      ...
      //                 alert("markAsFocused=");
        ...
        //    alert("textbox=" + textbox.value + " dataField=" + dataField + " rowIndex=" + rowIndex);
            var BoxAccKrd = window.parent.document.getElementById('MainContent_mySpl01_ctl01_ctl01_mySplKrd_ctl00_ctl01_BoxAccKrd_ob_CboBoxAccKrdTB').value;
        //    alert("BoxAccKrd=" + BoxAccKrd);
            var BoxMolKrd = window.parent.document.getElementById('MainContent_mySpl01_ctl01_ctl01_mySplKrd_ctl00_ctl01_BoxMolKrd_ob_CboBoxMolKrdTB').value;
       //     alert("BoxMolKrd=" + BoxMolKrd);

       //     alert("markAsBlured=" + textbox.value);
            if (textbox.value == "" || textbox.value == "0") return;

            if (BoxAccKrd == "" && BoxMolKrd == "")
            {
                alert("Не выбран счет или МОЛ");
                return;
    ...
    */
            ...
            var ParStr = document.getElementById('parBuxSid').value + ':' + document.getElementById('parBuxFrm').value + ':' + document.getElementById('parBuxKod').value + ':' +
                         GridDeb.Rows[rowIndex].Cells['MATKOD'].Value + ':Прм:' + document.getElementById('parDocIdn').value + ':' +
                         Zen + ':' + Kol + ':' + Pay + ':' +
    ...
    <%-- ************************************* программа C# **************************************************** --%>
     ...
     //       TekMolKrd = Convert.ToString(Request.QueryString["TekMolKrd"]);
            TekPrxIdn = Convert.ToString(Request.QueryString["TekPrxIdn"]);
        ...
        public void CreateGridDeb(string TekAccDeb, string TekMolDeb)
        {
            ...
            int TekDocIdn = Convert.ToInt32(Session["GLVDOCIDN"]);
              ...
              // создание DataSet.
                        ...
                        cmd.Parameters.Add("@MATPRXIDN", SqlDbType.Int, 4).Value = TekPrxIdn;
