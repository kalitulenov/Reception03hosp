...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnClientSelect(selectedRecords) {
            var FndRes = "RES&" + document.getElementById("parFndSnd").value + "&" + selectedRecords[0].FNDSPR + "&" + selectedRecords[0].FNDKOD + "&" + selectedRecords[0].FNDTXT;
   //         alert("FndRes=" + FndRes);
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        parFndSnd.Value = Convert.ToString(Request.QueryString["FndSnd"]);
        parFndSpr.Value = Convert.ToString(Request.QueryString["FndSpr"]);
...
*/
    ...
    protected void FndBtn_Click(object sender, EventArgs e)
    {
        ...
        whereClause = "";
        if (FndFio.Text != "") whereClause += "%" + FndFio.Text.Replace("'", "''") + "%";
        ...
        if (whereClause != "")
        {
            ...
            cmd.Parameters.Add("@FNDSPR", SqlDbType.VarChar).Value = parFndSpr.Value;
...
<body>
    ...
    <%-- ============================  для передач значении  ============================================ --%>
        <asp:HiddenField ID="parFndSpr" runat="server" />
        <asp:HiddenField ID="parFndSnd" runat="server" />
    <%-- ============================  для передач значении  ============================================ --%>
        ...
        <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="Vertical"
            ...
            <%-- ============================  шапка экрана ============================================ --%>
             <table border="0" cellspacing="0" width="100%" cellpadding="0">
                        <tr>
                            <td width="5%" class="PO_RowCap" align="left">НАИМЕНОВАНИЕ:</td>
                            <td width="50%">
            ...
            <obout:Grid ID="GridFnd" runat="server"
                CallbackMode="true"
                Serialize="true"
