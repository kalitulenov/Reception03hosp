<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MsrMain.Master" AutoEventWireup="True" CodeBehind="BuxDocAkt.aspx.cs" Inherits="Reception03hosp45.BuxDoc.BuxDocAkt" %>
    ...
    <script type="text/javascript">
        ...
        function PrtAktButton_Click() {
            ...
            if (ua.search(/Chrome/) > -1)
                window.open("/Report/DauaReports.aspx?ReportName=BuxAktDoc&TekDocIdn=" + DatDocIdn,
        ...
        function PrtFktButton_Click() {
            ...
            if (ua.search(/Chrome/) > -1)
                window.open("/Report/DauaReports.aspx?ReportName=BuxFktDoc&TekDocIdn=" + DatDocIdn,
                    "ModalPopUp", "toolbar=no,width=900,height=650,left=200,top=100,location=no,modal=1,status=no,scrollbars=no,resize=no,fullscreen=yes");
            else
                window.showModalDialog("/Report/DauaReports.aspx?ReportName=BuxFktDoc&TekDocIdn=" + DatDocIdn,
                    "ModalPopUp", "center:yes;resizable:yes;status:no;dialogleft:200px;dialogtop:100px;dialogWidth:900px;dialogHeight:650px;");
        }
    </script>
...
<%-- ============================  верхний блок  ============================================ --%>
    <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double"
        ...
        <table border="0" cellspacing="0" width="100%" cellpadding="0">
            ...
            <tr>
                ...
                <td width="10%" style="vertical-align: top;">
                    <asp:Label ID="Label3" runat="server" align="center" Style="font-weight: bold;" Text="Страховщик:"></asp:Label>
                </td>
                <td style="vertical-align: top; width: 40%">
                    ...
                    <obout:ComboBox runat="server"
                        ...
                        EmptyText="Выберите cтраховщика ..."
                        DataSourceID="sdsStx"
            ...
            <!--  ----------------------------------------------------------------------------------------------------------------  -->
               <td width="10%" style="vertical-align: top;">
                    <asp:Label ID="Label4" runat="server" align="center" Style="font-weight: bold;" Text="Период:"></asp:Label>
                </td>
                <td width="40%" style="vertical-align: top;">
                    <asp:TextBox runat="server" ID="TxtDatBeg" Width="80px" />
                    ...
                    <asp:TextBox runat="server" ID="TxtDatEnd" Width="80px" />
                ...
                <td width="10%" style="vertical-align: top;">
                    <asp:Label ID="Label6" runat="server" align="center" Style="font-weight: bold;" Text="Скидка:"></asp:Label>
                </td>
                <td style="vertical-align: top; width: 40%">
                     <asp:TextBox ID="TxtPrz" Width="50%" Height="16" runat="server" Style="font-weight: 700; font-size: small; text-align: center" />
               </td>
            </tr>
    ...
    <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double"
        ...
        <obout:Grid runat="server"
            ...
            <Columns>
                ...
                <obout:Column ID="Column01" DataField="DTLNNN" HeaderText="№" Width="6%" ReadOnly="true" />
                <obout:Column ID="Column02" DataField="DTLDAT" HeaderText="Дата" Width="7%" DataFormatString = "{0:dd/MM/yy}" />
                <obout:Column ID="Column03" DataField="DTLNAM" HeaderText="Наименование" Width="25%" />
                <obout:Column ID="Column04" DataField="DTLMEM" HeaderText="ФИО" Width="15%" />
                <obout:Column ID="Column05" DataField="DTLKOL" HeaderText="Кол-во" Align="right" Width="5%" DataFormatString="{0:F2}" />
                <obout:Column ID="Column06" DataField="DTLEDN" HeaderText="Ед.изм" Width="10%">
                ...
                <obout:Column ID="Column08" DataField="DTLPRZ" HeaderText="Скидка" Width="5%" DataFormatString="{0:F2}" Align="right" />
 ...
 <%-- ============================  нижний блок  ============================================ --%>
  ...
  <asp:Panel ID="PanelBot" runat="server" BorderStyle="Double" 
             ...
             <center>
                 <asp:Button ID="CmpButton" runat="server" CommandName="Cmp" Text="Сформировать" onclick="CmpButton_Click"/>
                 ...
                 <input type="button" name="PrtFktButton" value="Печать (Счет_фак)" id="FktButton" onclick="PrtFktButton_Click();">
