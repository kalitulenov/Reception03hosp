<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MsrMain.Master" AutoEventWireup="True" CodeBehind="BuxDocPrxFix.aspx.cs" Inherits="Reception03hosp45.BuxDoc.BuxDocPrxFix" %>
...
<%-- ============================  шапка экрана ============================================ --%>
       <asp:TextBox ID="Sapka0" 
             Text="Приходные накладные (основные средства)" 
             BackColor="#3CB371"  
             Font-Names="Verdana" 
             Font-Size="20px" 
             Font-Bold="True" 
    ...
    <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double"
        ...
        <obout:Grid runat="server"
            ...
            <Columns>
                ...
                <obout:Column ID="Column02" DataField="DTLNAM" HeaderText="НАИМЕНОВАНИЕ" Width="19%" />
                <obout:Column ID="Column03" DataField="DTLKOL" HeaderText="КОЛ-ВО" Align="right" Width="5%" DataFormatString="{0:F2}" />
                <obout:Column ID="Column04" DataField="DTLEDN" HeaderText="ЕД.ИЗМ" Width="5%">
                    <TemplateSettings TemplateId="TemplateEdn" EditTemplateId="TemplateEditEdn" />
                </obout:Column>
                <obout:Column ID="Column07" DataField="DTLZEN" HeaderText="ЦЕНА" Align="right" Width="5%" DataFormatString="{0:F2}" />
                <obout:Column ID="Column08" DataField="DTLNDC" HeaderText="НДС" Align="center" Width="3%">
                ...
                <obout:Column ID="Column10" DataField="DTLGRP" HeaderText="АМР.ГРП" Width="10%">
                    <TemplateSettings TemplateId="TemplateGrp" EditTemplateId="TemplateEditGrp" />
                </obout:Column>
                <obout:Column ID="Column11" DataField="DTLPRZ" HeaderText="% ИЗН" Width="3%" Align="right" DataFormatString="{0:F0}" />
                <obout:Column ID="Column12" DataField="DTLGRPNAL" HeaderText="НАЛ.ГРП" Width="7%" >
                    <TemplateSettings TemplateId="TemplateNal" EditTemplateId="TemplateEditNal" />
                </obout:Column>
                <obout:Column ID="Column13" DataField="DTLBXDIZN" HeaderText="ВХ.ИЗН" Width="5%" Align="right" DataFormatString="{0:F2}" />
                <obout:Column ID="Column14" DataField="DTLSRKSLB" HeaderText="СРОК СЛЖБ" DataFormatString="{0:dd/MM/yy}" ApplyFormatInEditMode="true" Width="8%" />
                <obout:Column ID="Column15" DataField="DTLDATIZG" HeaderText="ДАТА ИЗГ." DataFormatString="{0:dd/MM/yy}" ApplyFormatInEditMode="true" Width="8%" />
                <obout:Column ID="Column16" DataField="DTLNUMIZG" HeaderText="№ ЗАВ." Width="7%" />
            ...
            <Templates>
                ...
                <obout:GridTemplate runat="server" ID="TemplateGrp">
                    <Template>
                        <%# Container.DataItem["NAMAMR"]%>
                    </Template>
                </obout:GridTemplate>
                <obout:GridTemplate runat="server" ID="TemplateEditGrp" ControlID="ddlGrp" ControlPropertyName="value">
                    <Template>
                        <asp:DropDownList ID="ddlGrp" runat="server" AppendDataBoundItems="True" Width="99%" DataSourceID="sdsGrp" CssClass="ob_gEC" DataTextField="NAMAMR" DataValueField="AMRKOD">
                            <asp:ListItem Text="Выберите ..." Value="" Selected="True" />
                        </asp:DropDownList>
                    </Template>
                </obout:GridTemplate>

                <obout:GridTemplate runat="server" ID="TemplateNal">
                    <Template>
                        <%# Container.DataItem["NAMNAL"]%>
                    </Template>
                </obout:GridTemplate>
                <obout:GridTemplate runat="server" ID="TemplateEditNal" ControlID="ddlNal" ControlPropertyName="value">
                    <Template>
                        <asp:DropDownList ID="ddlNal" runat="server" AppendDataBoundItems="True" Width="99%" DataSourceID="sdsNal" CssClass="ob_gEC" DataTextField="NAMNAL" DataValueField="NALKOD">
                            <asp:ListItem Text="Выберите ..." Value="" Selected="True" />
                        </asp:DropDownList>
                    </Template>
                </obout:GridTemplate>
...
<%-- =================  источник  для КАДРЫ ============================================ --%>
            ...
            <asp:SqlDataSource runat="server" ID="sdsNal" SelectCommand="" ConnectionString="" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
