 ...
 //                       alert("hashes=" + hashes[0]);
    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sdsDeb.SelectCommand = "SELECT ACCKOD,ACCKOD+'.'+ACCNAM AS NAM FROM TABACC WHERE ACCFRM=" + BuxFrm + "AND LEFT(ACCKOD,4)<>'1010' AND ACCPRV=1 ORDER BY ACCKOD";
        ...
        // ============================ чтение заголовка таблицы а оп ==============================================
             void getDocNum()
                  ...
                  //          KASKTO.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["KASSPRVAL"]);
                            ...
                            KASDOCNUM.Text = Convert.ToString(ds.Tables[0].Rows[0]["DOCDNN"]);
                            KASDOCDAT.Text = Convert.ToString(ds.Tables[0].Rows[0]["DOCDDT"]);
                            KASDOCVID.Text = Convert.ToString(ds.Tables[0].Rows[0]["DOCDPL"]);
                            
                            KASDOC.Text = Convert.ToString(ds.Tables[0].Rows[0]["KASDOC"]);
...
//                        getGrid();
                    ...
                    protected void btnOK_click(object sender, EventArgs e)
                    {
                        ...
                        cmd.Parameters.Add("@KASDOC", SqlDbType.VarChar).Value = KASDOC.Text;
    ...
    <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double"
        ...
        <table border="1" cellspacing="0" width="100%">
            <tr>
                ...
                <td width="17%" align="center" style="font-weight: bold; background-color: yellow" class="PO_RowCap">Назачения</td>
            </tr>
            ...
            <tr>
                ...
                <td width="12%" class="PO_RowCap">
                    <asp:TextBox runat="server" ID="KASDAT" Width="70px" />
                ...
                <td width="17%" colspan="3" class="PO_RowCap">
            ...
            <tr>
                <td width="5%" align="center" style="font-weight: bold;" class="PO_RowCap">Принят</td>
                <td width="12%" class="PO_RowCap">
                ...
                <td width="10%" colspan="4" class="PO_RowCap" style="font-weight: bold;"> 
                    № уд.   
                    <asp:TextBox ID="KASDOCNUM" Font-Size="Medium" ReadOnly="true" style="text-align:left" Width="27%" Height="20" runat="server" BackColor="#FFFFE0" />
                    от  
                    <asp:TextBox ID="KASDOCDAT" Font-Size="Medium" ReadOnly="true" style="text-align:left" Width="20%" Height="20" runat="server" BackColor="#FFFFE0" />
                    Выдан
                    <asp:TextBox ID="KASDOCVID" Font-Size="Medium" ReadOnly="true" style="text-align:left" Width="17%" Height="20" runat="server" BackColor="#FFFFE0" />
                </td>
            </tr>
            
            <tr>
                <td width="5%" align="center" style="font-weight: bold;" class="PO_RowCap">Основание</td>
            ...
            <tr>
                <td width="5%" align="center" style="font-weight: bold;" class="PO_RowCap">Документ</td>
                <td width="85%" colspan="8" class="PO_RowCap">
                    <asp:TextBox ID="KASDOC" Font-Size="Medium" Font-Bold="true" style="text-align:left" Width="98%" Height="20" runat="server" BackColor="#FFFFE0" />
                </td>
            </tr>
