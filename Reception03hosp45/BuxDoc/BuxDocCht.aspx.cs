...
{
    public partial class BuxDocCht : System.Web.UI.Page
    {
        int GlvDocIdn;
        string GlvDocPrv;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sdsStx.SelectCommand = "SELECT ORGKOD,ORGNAM FROM SprOrg WHERE ORGFRM=" + BuxFrm;
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (GlvDocIdn == 0)  // новый документ
                {
                    ...
                    cmd.Parameters.Add("@GLVDOCTYP", SqlDbType.VarChar).Value = "Счт";
        ...
        void getDocNum()
        {
            ...
            if (GlvDocIdn > 0)
            {
                ...
                TxtDog.Text = Convert.ToString(ds.Tables[0].Rows[0]["DOCNUMFKT"]);
        ...
        void InsertRecord(object sender, GridRecordEventArgs e)
        {
            ...
            if (Convert.ToInt32(e.Record["DTLKOD"]) == null || Convert.ToInt32(e.Record["DTLKOD"]) == 0) DtlKod = 0;
        ...
        protected void btnOK_click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add("@DOCNUMFKT", SqlDbType.VarChar).Value = TxtDog.Text;
            ...
            Response.Redirect("~/BuxDoc/BuxDoc.aspx?NumSpr=Счт&TxtSpr=Счет на оплату");
        }
