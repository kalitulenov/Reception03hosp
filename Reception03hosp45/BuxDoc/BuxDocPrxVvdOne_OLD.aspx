...
//        Session.Add("GlvDocIdn ", GlvDocIdn);
        ...
        if (!Page.IsPostBack)
        {
            ...
            TxtNam.Attributes.Add("onchange", "onChange('TxtNam',TxtNam.value);");
            TxtKol.Attributes.Add("onchange", "onChange('TxtKol',TxtKol.value);");
            TxtUpk.Attributes.Add("onchange", "onChange('TxtUpk',TxtUpk.value);");
            TxtZen.Attributes.Add("onchange", "onChange('TxtZen',TxtZen.value);");
            TxtPrz.Attributes.Add("onchange", "onChange('TxtPrz',TxtPrz.value);");
            //============= Установки ===========================================================================================
            GlvDocIdnTek = (string)Session["GlvDocIdn"];
            if (GlvDocIdnTek != "Post")
            //         if ((string)Session["PostBack"] == "tt")
            {
                ...
                if (GlvDocIdn == "0")  // новый документ
                {
                    ...
                    try
                    {
                        ...
                        GlvDocIdn = Convert.ToString(cmd.Parameters["@USLIDN"].Value);
                    }
                    finally
                    {
                        con.Close();
  ...
  //      SqlCommand cmd = new SqlCommand("SELECT * FROM AMBUSL WHERE USLIDN=" + parUslIdn.Value, con);        // указать тип команды
    ...
    protected void BoxUsl_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (TekUsl > 0)
        {
            ...
            cmd.Parameters.Add("@USLIDN", SqlDbType.VarChar).Value = GlvDocIdn;
            ...
            <table border="0" cellspacing="0" width="100%" cellpadding="0">
                 <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label8" Text="СЧЕТ:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                        <obout:ComboBox runat="server"
                            ...
                            OnSelectedIndexChanged="BoxDeb_OnSelectedIndexChanged"
                            DataSourceID="sdsDeb"
                ...
                <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label11" Text="НАИМЕНОВАНИЕ:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                        <asp:TextBox ID="TxtNam" Width="10%" Height="20" runat="server" ReadOnly="true"
                ...
                <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label12" Text="КОЛИЧЕСТВО:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                ...
                <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label1" Text="ЕД.ИЗМЕРЕНИЯ:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                        <obout:ComboBox runat="server"
                            AutoPostBack="true"
                            ID="BoxEdn"
                            Width="40%"
               ...
               <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label10" Text="ЦЕНА:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                ...
                <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label4" Text="СУММА:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                 ...
                 <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label9" Text="НАДБАВКА:" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                ...
                <tr>
                    <td style="width: 100%; height: 30px;">
                        <asp:Label ID="Label6" Text="ГРУППА:" runat="server" Width="20%" Font-Bold="true"  Font-Size="Medium"/>
                        <obout:ComboBox runat="server"
                            AutoPostBack="true"
                            ID="BoxGrp"
                            Width="70%"
...
<%-- 
    <asp:SqlDataSource runat="server" ID="sdsUsl" SelectCommand="HspAmbUslKodSou" SelectCommandType="StoredProcedure"
        ...
        <SelectParameters>
            ...
            <asp:SessionParameter SessionField="GlvDocIdn" Name="GlvDocIdn" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
 --%>  
