        ...
        <asp:Panel ID="PanelMid" runat="server" BorderStyle="Double" ScrollBars="Vertical"
            ...
            <obout:Grid ID="GridUsl" runat="server"
                ...
                <ScrollingSettings ScrollHeight="300" />
                 <ClientSideEvents OnBeforeClientEdit="GridUsl_Edit" ExposeSender="true" />
               <Columns>
                    ...
                    <obout:Column ID="Column04" DataField="GRFKOD" HeaderText="ВРАЧ" Width="19%">
                        <TemplateSettings TemplateId="TemplateDocNam" />
                    </obout:Column>
                    <obout:Column ID="Column05" DataField="DLGNAM" HeaderText="СПЕЦ." Width="5%" ReadOnly="true" />
                    <obout:Column ID="Column06" DataField="KODUSL" HeaderText="НАИМЕНОВАНИЕ УСЛУГИ" Width="32%" Align="left">
                        <TemplateSettings TemplateId="TemplateUslNam" EditTemplateId="TemplateEditUslNam" />
                    </obout:Column>
                    <obout:Column ID="Column07" DataField="USLLGT" HeaderText="ЛЬГ." Width="4%" />
                    <obout:Column ID="Column08" DataField="USLKOL" HeaderText="КОЛ" Width="3%" />
                    <obout:Column ID="Column09" DataField="USLZEN" HeaderText="ЦЕНА" Width="5%" ReadOnly="true" />
                    <obout:Column ID="Column10" DataField="USLSUM" HeaderText="СУММА" Width="9%" />
                    <obout:Column ID="Column11" HeaderText="Коррек  Удаление" Width="10%" AllowEdit="true" AllowDelete="true" runat="server">
                ...
                <Templates>
                   ...
                   <obout:GridTemplate runat="server" ID="TemplateEditUslNam" ControlID="SprUslCombo">
                        <Template>
                            <obout:ComboBox runat="server" ID="SprBuxCombo" AutoClose="false" Width="100%" Height="150" AppendDataBoundItems="false"
                                DataSourceID="sdsKto" DataTextField="BUXNAM" DataValueField="BUXKOD"
                                EmptyText="Выберите врача ....">
                                <Details>
                                    <obout:ComboBox runat="server" ID="SprUslCombo"
                                        EnableLoadOnDemand="true" OnLoadingItems="Detail_LoadingItems" Width="200" Height="150"
                                        DataSourceID="sdsUsl" DataTextField="NAMUSL" DataValueField="KODUSL"
...
<%-- =================  диалоговое окно для подтверждения записи докуумента  ============================================ --%>
    ...
    <asp:SqlDataSource runat="server" ID="sdsUsl" SelectCommand="HspAmbUslPltSou"  SelectCommandType="StoredProcedure" 
         ProviderName="System.Data.SqlClient">
         <SelectParameters>
                <asp:Parameter Name="USLDOC" Type="String" />
         </SelectParameters>
    </asp:SqlDataSource>	
