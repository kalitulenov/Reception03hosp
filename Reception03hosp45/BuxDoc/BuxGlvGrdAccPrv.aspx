...
<%-- ============================  JAVA ============================================ --%>
     <script type="text/javascript">
       ...
       //      if (cellIndex == 1) {
             ...
             //        alert('OnClientSelect3=');
                 var GlvDocDeb = GridAcc.Rows[rowIndex].Cells[4].Value;
             //        alert('OnClientSelect4=' + GlvDocDeb);
                 var GlvDocKrd = GridAcc.Rows[rowIndex].Cells[5].Value;
  ...
  <script runat="server">
      ...
      protected void Page_Load(object sender, EventArgs e)
      {
          ...
          ComParSpr = (string)Request.QueryString["AccSpr"];
          ComParSprVal = (string)Request.QueryString["AccSprVal"];
      ...
      protected void LoadGrid()
      {
          ...
          cmd.Parameters.Add("@ACCSPR", SqlDbType.VarChar).Value = ComParSpr;
          cmd.Parameters.Add("@ACCSPRVAL", SqlDbType.VarChar).Value = ComParSprVal;
            ...
            <div>
                ...
                <obout:Grid ID="GridAcc" runat="server"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="Column02" DataField="PRVNUM" HeaderText="№" ReadOnly="true" Align="right" Width="5%" />
                        <obout:Column ID="Column03" DataField="PRVDAT" HeaderText="ДАТА" ReadOnly="true" Align="right" Width="7%" DataFormatString="{0:dd/MM/yy}" />
                        <obout:Column ID="Column04" DataField="PRVACC" HeaderText="ДЕБЕТ" ReadOnly="true" Width="7%" Align="left" />
                        <obout:Column ID="Column05" DataField="PRVCOR" HeaderText="КРЕДИТ" ReadOnly="true" Align="left" Width="7%" />
                        <obout:Column ID="Column06" DataField="PRVSUM" HeaderText="СУММА" ReadOnly="true" Align="right" Width="12%" DataFormatString="{0:N}" />
