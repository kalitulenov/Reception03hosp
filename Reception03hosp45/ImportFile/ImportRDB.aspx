...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script runat="server">
        ...
        public void ImportDataFromExcel(string excelFilePath)
        {
            ...
            string ssqltable = "TAB_DSP";
            // make sure your sheet name is correct, here sheet name is sheet1, so you can change your sheet name if have    different 
            string myexceldataquery = "SELECT '" + BuxFrm + "',* FROM [spis_pac_sostoit$]";
            try
            {
                ...
                string sclearsql = "DELETE FROM TAB_DSP WHERE DSPFRM='" + BuxFrm + "'";
                ...
                SqlCommand sqlcmdMrg = new SqlCommand("HspRdbImpExl", sqlconn);
                ...
                lblMessage.Text = "ЭРДБ ЗАГРУЖЕН В БАЗУ.";
