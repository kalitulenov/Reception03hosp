...
<script runat="server">
    ...
    void GetGrid()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            TxtRslMem.Text = Convert.ToString(ds.Tables[0].Rows[0]["EodRslMem"]);
            ...
            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodRslSvd001"].ToString())) BoxRslSvd001.SelectedValue = "0";
            else BoxRslSvd001.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["EodRslSvd001"]);

            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodRslSvd002"].ToString())) BoxRslSvd002.SelectedValue = "0";
            else BoxRslSvd002.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["EodRslSvd002"]);

            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodRslSvd003"].ToString())) BoxRslSvd003.SelectedValue = "0";
            else BoxRslSvd003.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["EodRslSvd003"]);

            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodRslIsp001"].ToString())) BoxRslIsp001.SelectedValue = "0";
            else BoxRslIsp001.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["EodRslIsp001"]);

            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodRslIsp002"].ToString())) BoxRslIsp002.SelectedValue = "0";
            else BoxRslIsp002.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["EodRslIsp002"]);

            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodRslIsp003"].ToString())) BoxRslIsp003.SelectedValue = "0";
            else BoxRslIsp003.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["EodRslIsp003"]);
    ...
    protected void ChkButton_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToString(BoxRslSvd001.SelectedValue) == null || Convert.ToString(BoxRslSvd001.SelectedValue) == "") EodRslSvd001 = "";
        else EodRslSvd001 = Convert.ToString(BoxRslSvd001.SelectedValue);

        if (Convert.ToString(BoxRslSvd002.SelectedValue) == null || Convert.ToString(BoxRslSvd002.SelectedValue) == "") EodRslSvd002 = "";
        else EodRslSvd002 = Convert.ToString(BoxRslSvd002.SelectedValue);

        if (Convert.ToString(BoxRslSvd003.SelectedValue) == null || Convert.ToString(BoxRslSvd003.SelectedValue) == "") EodRslSvd003 = "";
        else EodRslSvd003 = Convert.ToString(BoxRslSvd003.SelectedValue);


        if (Convert.ToString(BoxRslIsp001.SelectedValue) == null || Convert.ToString(BoxRslIsp001.SelectedValue) == "") EodRslIsp001 = "";
        else EodRslIsp001 = Convert.ToString(BoxRslIsp001.SelectedValue);

        if (Convert.ToString(BoxRslIsp002.SelectedValue) == null || Convert.ToString(BoxRslIsp002.SelectedValue) == "") EodRslIsp002 = "";
        else EodRslIsp002 = Convert.ToString(BoxRslIsp002.SelectedValue);

        if (Convert.ToString(BoxRslIsp003.SelectedValue) == null || Convert.ToString(BoxRslIsp003.SelectedValue) == "") EodRslIsp003 = "";
        else EodRslIsp003 = Convert.ToString(BoxRslIsp003.SelectedValue);
        ...
        // создание команды
        SqlCommand cmd = new SqlCommand("EodLstGrdOneRslRep", con);
        cmd = new SqlCommand("EodLstGrdOneRslRep", con);
        // указать тип команды
        cmd.CommandType = CommandType.StoredProcedure;
        // создать коллекцию параметров
        cmd.Parameters.Add("@BUXFRM", SqlDbType.VarChar).Value = BuxFrm;
        cmd.Parameters.Add("@EodIdn", SqlDbType.VarChar).Value = parEodIdn.Value;   // EodIdn;
        cmd.Parameters.Add("@EodRslEnd", SqlDbType.VarChar).Value = EodRslEnd;
        cmd.Parameters.Add("@EodRslPor", SqlDbType.VarChar).Value = EodRslPor;
        cmd.Parameters.Add("@EodRslMem", SqlDbType.VarChar).Value = EodRslMem;

        cmd.Parameters.Add("@EodRsl", SqlDbType.VarChar).Value = EodRsl;
        cmd.Parameters.Add("@EodRslSvd001", SqlDbType.VarChar).Value = EodRslSvd001;
        cmd.Parameters.Add("@EodRslSvd002", SqlDbType.VarChar).Value = EodRslSvd002;
        cmd.Parameters.Add("@EodRslSvd003", SqlDbType.VarChar).Value = EodRslSvd003;

        cmd.Parameters.Add("@EodRslIsp001", SqlDbType.VarChar).Value = EodRslIsp001;
        cmd.Parameters.Add("@EodRslIsp002", SqlDbType.VarChar).Value = EodRslIsp002;
        cmd.Parameters.Add("@EodRslIsp003", SqlDbType.VarChar).Value = EodRslIsp003;

        cmd.Parameters.Add("@EodRslRdy", SqlDbType.Bit, 1).Value = FlgBip;
    ...
    protected void IspButton_Click(object sender, EventArgs e)
    {
        ...
        // создание команды
        SqlCommand cmd = new SqlCommand("EodLstGrdOneRslIsp", con);
        cmd = new SqlCommand("EodLstGrdOneRslIsp", con);
        // указать тип команды
        cmd.CommandType = CommandType.StoredProcedure;
        // создать коллекцию параметров
        cmd.Parameters.Add("@BUXFRM", SqlDbType.VarChar).Value = BuxFrm;
        ...
        <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double"
           ...
           <table border="0" cellspacing="0" width="100%"  bgcolor="yellow" cellpadding="0">
            ...
            <table border="0" cellspacing="0" width="100%" bgcolor="yellow" cellpadding="0">
                ...
                <tr style="height: 35px">
                    ...
                    <td width="35%" style="vertical-align: top;">
                       <obout:ComboBox runat="server" ID="BoxRslIsp001" Width="95%" Height="200"
                            FolderStyle="/Styles/Combobox/Plain"
                            DataSourceID="sdsSvd" DataTextField="FIO" DataValueField="BUXKOD">
                        </obout:ComboBox>
                        <obout:ComboBox runat="server" ID="BoxRslIsp002" Width="95%" Height="200"
                            FolderStyle="/Styles/Combobox/Plain"
                            DataSourceID="sdsSvd" DataTextField="FIO" DataValueField="BUXKOD">
                        </obout:ComboBox>
                        <obout:ComboBox runat="server" ID="BoxRslIsp003" Width="95%" Height="200"
                            FolderStyle="/Styles/Combobox/Plain"
                            DataSourceID="sdsSvd" DataTextField="FIO" DataValueField="BUXKOD">
                        </obout:ComboBox>
                    </td>
                    ...
                    <td width="35%" style="vertical-align: top;">
                        <obout:ComboBox runat="server" ID="BoxRslSvd001" Width="95%" Height="200"
                            FolderStyle="/Styles/Combobox/Plain"
                            DataSourceID="sdsSvd" DataTextField="FIO" DataValueField="BUXKOD">
                        </obout:ComboBox>
                        <obout:ComboBox runat="server" ID="BoxRslSvd002" Width="95%" Height="200"
                            FolderStyle="/Styles/Combobox/Plain"
                            DataSourceID="sdsSvd" DataTextField="FIO" DataValueField="BUXKOD">
                        </obout:ComboBox>
                        <obout:ComboBox runat="server" ID="BoxRslSvd003" Width="95%" Height="200"
                            FolderStyle="/Styles/Combobox/Plain"
                            DataSourceID="sdsSvd" DataTextField="FIO" DataValueField="BUXKOD">
                        </obout:ComboBox>
                    </td>
           ...
           <table border="0" cellspacing="0" width="100%" bgcolor="yellow" cellpadding="0">
                ...
                <tr style="height: 35px">
                    ...
                    <td width="80%" style="vertical-align: top;">
                        <obout:OboutTextBox runat="server" ID="TxtRslMem" Width="98%" BackColor="White" Height="30px"
                            TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
                        </obout:OboutTextBox>
                    </td>
                </tr>
