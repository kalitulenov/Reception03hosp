...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrtButton_Click() {
            ...
            var ua = navigator.userAgent;
            if (ua.search(/Chrome/) > -1)
                window.open("/Report/DauaReports.aspx?ReportName=EodLstGrdOne061&TekDocIdn=" + DatDocIdn,
                ...
                window.showModalDialog("/Report/DauaReports.aspx?ReportName=EodLstGrdOne061&TekDocIdn=" + DatDocIdn,
        ...
        <asp:Panel ID="PanelTop" runat="server" BorderStyle="Double"
            ...
            <table border="0" cellspacing="0" width="100%" cellpadding="0">
                ...
                <tr style="height: 20px">
                    ...
                    <td width="10%" style="vertical-align: top;" class="PO_RowCap">&nbsp;</td>
                    <td width="35%" style="vertical-align: top;">
                        <asp:Label ID="Lbl000" Text="" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                        </br>
                        <asp:Label ID="Label1" Text="" runat="server" Width="20%" Font-Bold="true" Font-Size="Medium" />
                    </td>
