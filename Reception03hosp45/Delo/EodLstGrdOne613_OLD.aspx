...
<script runat="server">
    ...
    void GetGrid()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodIspFlg"].ToString())) FlgSvd.Checked = false;
            else FlgSvd.Checked = Convert.ToBoolean(ds.Tables[0].Rows[0]["EodIspFlg"]);
    ...
    protected void ChkButton_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@EodIspFlg", SqlDbType.Bit, 1).Value = FlgIsp;
