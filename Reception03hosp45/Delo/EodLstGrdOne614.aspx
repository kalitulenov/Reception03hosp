...
<script runat="server">
    ...
    void GetGrid()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (String.IsNullOrEmpty(ds.Tables[0].Rows[0]["EodBipRes"].ToString())) BoxIspRes.SelectedValue = "0";
            else BoxIspRes.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["EodBipRes"]);
    ...
    protected void ChkButton_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToString(BoxIspRes.SelectedValue) == null || Convert.ToString(BoxIspRes.SelectedValue) == "") EodBipRes = "";
        else EodBipRes = Convert.ToString(BoxIspRes.SelectedValue);
        ...
        cmd.Parameters.Add("@EodIspWho", SqlDbType.VarChar).Value = EodIspWho;
        cmd.Parameters.Add("@EodBipRes", SqlDbType.VarChar).Value = EodBipRes;
        cmd.Parameters.Add("@EodIspFlg", SqlDbType.Bit, 1).Value = 0;
           ...
           <table border="0" cellspacing="0" width="100%" cellpadding="0">
            ...
            <table border="0" cellspacing="0" width="100%" bgcolor="yellow" cellpadding="0">
                ...
                <tr style="height: 35px">
                    ...
                    <!--  Результат ----------------------------------------------------------------------------------------------------------  -->
                    <td width="10%" style="vertical-align: top;" class="PO_RowCap">&nbsp;Результат:</td>
                    <td width="35%" style="vertical-align: top;">
                        <obout:ComboBox runat="server" ID="BoxIspRes" Width="40%" Height="200"
                            FolderStyle="/Styles/Combobox/Plain"
                            DataSourceID="sdsRes" DataTextField="EDOBIPNAM" DataValueField="EDOBIPKOD">
                        </obout:ComboBox>
                        &nbsp;Дата исп.:
