...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    //            alert(BegDat);
     //           alert(EndDat);
                //        alert("TekDocFrm =" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd + "&TekIinBeg=" + IinBeg + "&TekIinEnd=" + IinEnd);

                $(this).dialog("close");
                // =========================================================================================================================================================
                var ua = navigator.userAgent;
                if (ua.search(/Chrome/) > -1)
                    window.open("/Report/DauaReports.aspx?ReportName=HspAmbKrtTitAll&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + 
                        GrfFrm + "&TekIinBeg=" + IinBeg + "&TekIinEnd=" + IinEnd,
                    ...
                    window.showModalDialog("/Report/DauaReports.aspx?ReportName=HspAmbKrtTitAll&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + 
                        GrfFrm + "&TekIinBeg=" + IinBeg + "&TekIinEnd=" + IinEnd,
...
<script runat="server">
    ...
    // ======================================================================================
        ...
        <%-- ============================  для передач значении  ============================================ --%>
        <div class="InpBegEndDat" title=" Укажите ИИН для печати">
            <table>
                <tr>
                    <td>Нач.ИИН</td>
                    <td>
