...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    //            alert(BegDat);
     ...
     //           alert(document.getElementById('parBuxFrm').value);
                ...
                // =========================================================================================================================================================
                if (GrfFrm == 12)
                    window.open("/Report/DauaReports.aspx?ReportName=HspSttStxDocSvdKrd&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
                    ...
                    window.open("/Report/DauaReports.aspx?ReportName=HspSttStxDocSvd&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
                        "ModalPopUp", "toolbar=no,width=900,height=650,left=200,top=100,location=no,modal=1,status=no,scrollbars=no,resize=no,fullscreen=yes");
            },
            "Отмена": function () {
                $(this).dialog("close");
