    ...
    //            alert(BegDat);
     ...
     //           alert(document.getElementById('parBuxFrm').value);
                ...
                if (ua.search(/Chrome/) > -1)
                    window.open("/Report/DauaReports.aspx?ReportName=HspSttNapVopUsk&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
                    ...
                    window.showModalDialog("/Report/DauaReports.aspx?ReportName=HspSttNapVopUsk&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd,
