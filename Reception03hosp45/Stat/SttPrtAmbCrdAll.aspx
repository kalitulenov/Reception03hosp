    ...
    //            alert(BegDat);
     //           alert(EndDat);
                ...
                if (ua.search(/Chrome/) > -1)
                    window.open("/Report/DauaReports.aspx?ReportName=HspAmbKrtCemAll&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + 
                        GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd + "&TekIinBeg=" + IinBeg + "&TekIinEnd=" + IinEnd,
                    ...
                    window.showModalDialog("/Report/DauaReports.aspx?ReportName=HspAmbKrtCemAll&TekDocIdn=0&TekDocKod=0&TekDocFrm=" + 
                        GrfFrm + "&TekDocBeg=" + GrfBeg + "&TekDocEnd=" + GrfEnd + "&TekIinBeg=" + IinBeg + "&TekIinEnd=" + IinEnd,
