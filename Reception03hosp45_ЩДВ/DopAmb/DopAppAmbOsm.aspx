...
//             var GrfDocTyp = 'Dat';
  ...
  //           alert("DatDocIdn " + DatDocIdn);
             ...
             SqlStr = "UPDATE DOPCRD SET GRFCTRDAT=CONVERT(DATETIME,'" + DatDocVal + "',103) WHERE GRFIDN=" + DatDocIdn;
  ...
  //         alert("SqlStr=" + SqlStr);
             ...
             {
                 DatDocTyp='Sql';
                 SqlStr = "UPDATE DOPUSL SET USLNOZ="+DatDocVal+" WHERE USLAMB="+DatDocIdn;
       //          alert("SqlStr=" + SqlStr);
...
// --------------------- клише на анамнез жизни 
      ...
      //      alert('SblTyp=' + SblTyp);
             window.open("/Priem/DocAppSblFlg.aspx?SblTyp=" + SblTyp + "&Browser=Desktop", "ModalPopUp", "toolbar=no,width=1000,height=600,left=200,top=100,location=no,modal=yes,status=no,scrollbars=no,resize=no");
         }
 ...
 <!--  Нозология ----------------------------------------------------------------------------------------------------------  -->    
                        <tr> 
                              <td width="100%" style="vertical-align: central;" >
                                 <asp:Label id="LblPvd" Text="Повод обращения:" runat="server"  Width="11%" Font-Bold="true" />                             
                        ...
                        <tr> 
                            ...
                            <td width="7%" style="vertical-align: top;">
                             ...
                             <td width="90%" style="vertical-align: top;" >
                                 <obout:OboutTextBox runat="server" ID="Jlb003"  width="100%" BackColor="White" Height="90px"
...
<!--  Анамнез болезни ----------------------------------------------------------------------------------------------------------  -->    
                         <tr> 
                            ...
                            <td width="7%" style="vertical-align: top;">
                             ...
                             <td width="90%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="Anm003"  width="100%" BackColor="White" Height="90px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>
 ...
 <!--  Анамнез жизни----------------------------------------------------------------------------------------------------------  -->    
                         <tr> 
                            ...
                            <td width="7%" style="vertical-align: top;">
                             ...
                             <td width="90%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="AnmLif003"  width="100%" BackColor="White" Height="70px"
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>
             ...
             <!--  Статус ----------------------------------------------------------------------------------------------------------  --> 
                         <tr>                            
                            ...
                            <td width="7%" style="vertical-align: top;">
                             ...
                             <td width="90%" style="vertical-align: top;">
                                 <obout:OboutTextBox runat="server" ID="Stt003"  width="100%" BackColor="White" Height="70px" 
                                     TextMode="MultiLine" FolderStyle="~/Styles/Interface/plain/OboutTextBox">
		                             <ClientSideEvents OnTextChanged="onChange" />
		                         </obout:OboutTextBox>
                            </td>                     
